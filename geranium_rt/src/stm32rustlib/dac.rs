...
pub fn dac_swtrigr_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_SWTRIGR_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr12r1_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR12R1_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr12l1_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR12L1_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr8r1_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR8R1_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr12r2_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR12R2_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr12l2_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR12L2_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr8r2_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR8R2_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr12rd_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR12RD_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr12ld_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR12LD_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn dac_dhr8rd_write(value: u32) {
    unsafe { write_volatile((DAC_ADR + DAC_DHR8RD_OFFSET) as *mut u32, value) };
}
...
pub fn dac_swtrigr_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_SWTRIGR_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr12r1_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR12R1_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr12l1_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR12L1_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr8r1_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR8R1_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr12r2_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR12R2_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr12l2_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR12L2_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr8r2_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR8R2_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr12rd_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR12RD_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr12ld_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR12LD_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dhr8rd_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DHR8RD_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dor1_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DOR1_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn dac_dor2_read() -> u32 {
    unsafe { read_volatile((DAC_ADR + DAC_DOR2_OFFSET) as *mut u32) }
}
#[inline(always)]
