...
pub fn exti_imr_write(value: u32) {
    unsafe { write_volatile((EXTI_ADR + EXTI_IMR_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn exti_emr_write(value: u32) {
    unsafe { write_volatile((EXTI_ADR + EXTI_EMR_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn exti_rtsr_write(value: u32) {
    unsafe { write_volatile((EXTI_ADR + EXTI_RTSR_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn exti_ftsr_write(value: u32) {
    unsafe { write_volatile((EXTI_ADR + EXTI_FTSR_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn exti_swier_write(value: u32) {
    unsafe { write_volatile((EXTI_ADR + EXTI_SWIER_OFFSET) as *mut u32, value) };
}
#[inline(always)]
pub fn exti_pr_write(value: u32) {
    unsafe { write_volatile((EXTI_ADR + EXTI_PR_OFFSET) as *mut u32, value) };
}
    
        
#[inline(always)]
pub fn exti_imr_read() -> u32 {
    unsafe { read_volatile((EXTI_ADR + EXTI_IMR_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn exti_emr_read() -> u32 {
    unsafe { read_volatile((EXTI_ADR + EXTI_EMR_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn exti_rtsr_read() -> u32 {
    unsafe { read_volatile((EXTI_ADR + EXTI_RTSR_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn exti_ftsr_read() -> u32 {
    unsafe { read_volatile((EXTI_ADR + EXTI_FTSR_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn exti_swier_read() -> u32 {
    unsafe { read_volatile((EXTI_ADR + EXTI_SWIER_OFFSET) as *mut u32) }
}
#[inline(always)]
pub fn exti_pr_read() -> u32 {
    unsafe { read_volatile((EXTI_ADR + EXTI_PR_OFFSET) as *mut u32) }
}
    
        
#[inline(always)]
pub fn exti_imr_set(position: u32, size: u32, value: u32) {
    exti_imr_write(rep_bits(exti_imr_read(), position, size, value));
}
#[inline(always)]
pub fn exti_emr_set(position: u32, size: u32, value: u32) {
    exti_emr_write(rep_bits(exti_emr_read(), position, size, value));
}
#[inline(always)]
pub fn exti_rtsr_set(position: u32, size: u32, value: u32) {
    exti_rtsr_write(rep_bits(exti_rtsr_read(), position, size, value));
}
#[inline(always)]
pub fn exti_ftsr_set(position: u32, size: u32, value: u32) {
    exti_ftsr_write(rep_bits(exti_ftsr_read(), position, size, value));
}
#[inline(always)]
pub fn exti_swier_set(position: u32, size: u32, value: u32) {
    exti_swier_write(rep_bits(exti_swier_read(), position, size, value));
}
#[inline(always)]
pub fn exti_pr_set(position: u32, size: u32, value: u32) {
